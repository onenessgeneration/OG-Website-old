...
const contentData: Item[] = [
  ...
  },
  {
    ...
    description: [
      ...
      { description: "Sri Preethaji and Sri Krishnaji, known as Mukti Gurus, are enlightened masters and philosophers of our time. Their teachings, rooted in original wisdom and mystic technology, have awakened countless individuals to a life of peace, connection, and oneness. Imagine the most radiant, effortlessly cool and serene person, and then amplify that by a hundred—that is Sri Krishnaji. Discover a holistic approach to living that transcends limitations and opens the doors to a life of infinite possibilities." },
    ],
  },
];
